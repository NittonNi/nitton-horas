...
export function AccionesInforme({
  ...
  /** Se llama al terminar, con lo que ha pasado, para contarlo arriba. */
  ...
  function borrar() {
    const aviso =
      ids.length === 1
        ? "¿Borrar esta hora? No hay vuelta atrás."
        : `¿Borrar estas ${ids.length} horas? No hay vuelta atrás.`
